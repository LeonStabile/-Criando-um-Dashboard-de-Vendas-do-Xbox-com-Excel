...
Average Ticket: Valor médio gasto por subscritor (considerando plano + extras).

Auto-Renewal Rate: Percentagem de utilizadores com a renovação automática ativa.
...
B̳ases: A base de dados bruta (contém caracteres especiais no nome para fins de identificação).

Cálculos (Oculta): Tabelas dinâmicas e fórmulas de suporte para os gráficos.

A̳ssets: Guia de estilo, paleta de cores e logótipos utilizados.
